...
| `db/tests/` | 125 assertions. `db/tests/run.sh` rebuilds from nothing and runs them |
...
Verified in `db/tests/two_approver.sql`, 125 assertions, including every refusal.
