...
| | |
|---|---|
| Built | Schema, row level security, 70 database assertions, a prose gate with 74 tests, a commit hook |
...
```sh
./db/tests/run.sh          # schema from nothing, 70 assertions, ~20 seconds
...
db/tests/            70 assertions, run by db/tests/run.sh
